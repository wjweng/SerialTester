/*=============================================================================
 File:			Win32Com.cs					Win32 API Wrapper Class.
...
namespace SerialPorts
{
	...
	internal class Win32Com
	{
		...
		internal bool Open(string portName, bool overlapped)
		{
            ...
            //----------------------------------------------------------------
            int iPortNum = Convert.ToInt32(portName.Substring(3, portName.Length - 4), 10);
            if (iPortNum > 9)
		...
		{
			if(ReadFile(this.handle, buf, nToRead, out nRead, olMem) == false) 
			{
